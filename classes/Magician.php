...
class Magician extends Character
{
    ...
    public function magicBolt($target) {
        ...
        $status = "$this->name lance un éclair magique sur $target->name à qui il reste $target->healthPoints points de vie ! Il reste $target->magicPoints points de magie à $target->name !";
        return $status;
    }
